/*
Like `country_share_template.sql`, but only considering SciBERT-model predictions positive for publications in an
arXiv-covered subject, as defined by hand-coding of DIM, WOS, and MAG subjects.
*/
