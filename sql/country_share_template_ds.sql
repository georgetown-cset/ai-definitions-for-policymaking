/*
Like `country_share_arxiv_coverage_template.sql`, but only using DS data.
*/
with ntile_comparison as (
    select cset_id,
           ...
           ds_percentile                                                        percentile,
           ds_keyword_percentile                                                keyword_percentile,
           ds_elsevier_percentile                                               elsevier_percentile,
           ds_scibert_percentile                                                scibert_percentile,
           ds_scibert_cl_percentile                                             scibert_cl_percentile,
           ds_scibert_cv_percentile                                             scibert_cv_percentile,
           ds_scibert_ro_percentile                                             scibert_ro_percentile,
           ds_scibert_not_cv_percentile                                         scibert_not_cv_percentile
    from oecd.comparison
         -- Include only papers that appear in DS
    where comparison.ds_id is not null
),
