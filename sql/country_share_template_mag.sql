/*
Like `country_share_arxiv_coverage_template.sql`, but only using MAG data.
*/
with ntile_comparison as (
    select cset_id,
           ...
           mag_percentile                                                       percentile,
           mag_keyword_percentile                                               keyword_percentile,
           mag_elsevier_percentile                                              elsevier_percentile,
           mag_scibert_percentile                                               scibert_percentile,
           mag_scibert_cl_percentile                                            scibert_cl_percentile,
           mag_scibert_cv_percentile                                            scibert_cv_percentile,
           mag_scibert_ro_percentile                                            scibert_ro_percentile,
           mag_scibert_not_cv_percentile                                        scibert_not_cv_percentile
    from oecd.comparison
         -- Include only papers that appear in MAG
    where comparison.mag_id is not null
),
